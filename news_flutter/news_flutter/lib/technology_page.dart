  ...
  Widget titleTechnologyPage() {
    return Row(
      ...
      children: [
        ...
        Text(
          AppWidget.title[1] + " TECHNOLOGY " + AppWidget.title[2],
          style: TextStyle(
            fontSize: 15,
          ),
        ),
